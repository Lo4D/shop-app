...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:$method?key=${dotenv.env['API_KEY']}');
    try {
  ...
  Future<void> logout() async {
    ...
    notifyListeners();
    final prefs = await SharedPreferences.getInstance();
    // prefs.remove('userData'); removing only exact data
    prefs.clear(); // clearing prefs entirely
  }
